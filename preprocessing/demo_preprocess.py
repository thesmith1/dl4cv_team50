...
preprocessor_train.process_images(dest_dir, ['Acinonyx jubatus', 'Lycaon pictus', 'Zalophus californianus'])
preprocessor_val = Preprocessor(data_dir, val_annotations)
preprocessor_val.process_images(dest_dir, ['Acinonyx jubatus', 'Lycaon pictus', 'Zalophus californianus'])
